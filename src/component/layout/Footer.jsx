  ...
  return (
    <footer className="footer p-10 bg-gray-700 text-primary-content footer-center">
        <div>
            ...
            <p>Copyright &copy; {footerYear} Ahmed Hassan</p>
            <div className="flex flex-row gap-2">
                <button onClick={() => handleClickInFooter('github')}>
                    <FaGithub className='text-lg' 
                      ...
                      onMouseOut={() => {
                        setOrange(false)
                        setGit(false)}}
                      style={orange && git ? changeStyle.enter : changeStyle.leave}/>
                </button>
                <button onClick={() => handleClickInFooter('linkedin')}>
                    <FaLinkedin className='text-lg'
                      ...
                      style={orange && linkedin ? changeStyle.enter : changeStyle.leave} />
                </button>
            </div>
        </div>
    </footer>
